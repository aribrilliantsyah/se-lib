        ...
        <div class="card-header">
          <div class="row align-items-center">
            ...
            <div class="col-4 text-right">
              <a href="{{ route('author.create') }}" class="btn btn-sm btn-primary btn-fab btn-icon btn-round"><i class="fas fa-plus-square"></i> Create New Data</a>
            </div>
          </div>
        </div>
        <div class="card-body">
        ...
        $.ajax({
          ...
          success: function (response){
            ...
            setTimeout(() => {
              ...
              window.LaravelDataTables["author-table"].draw()
            }, 500);
          }
        });
      }
