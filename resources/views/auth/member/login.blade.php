        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Se-lib enjoy with us, muach 😘.</p>
              <p class="text-lead text-white">🚀 Member Area</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5 col-md-7">
          ...
          <div class="row mt-3">
            ...
            <div class="col-6 text-right">
              <a href="{{ url('member/register') }}" class="text-light"><small>Don't have an account? Sign up</small></a>
            </div>
          </div>
        </div>
      </div>
